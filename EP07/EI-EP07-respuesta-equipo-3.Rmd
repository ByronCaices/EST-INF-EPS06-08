...
-   **Variables Independientes:**
    ...
    -   Por lo tanto, se utiliza una prueba adecuada para comparar dos muestras independientes (en este caso, la **prueba de suma de rangos de Wilcoxon**)
        ...
        \
        Lo anterior se debe a que las muestras **no siguen una distribución normal**, tal y como se puede apreciar del resultado de aplicar la prueba de normalidad Shapiro-Wilk sobre ambas, donde el `p-value` para la muestra asociada a los tiempos del algoritmo A es menor a $0.05$; provocando que no sea posible aplicar una prueba paramétrica, como lo es la prueba t de Student, y en su lugar escogiendo una no paramétrica.
